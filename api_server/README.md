...
#### Содержание  
- [Авторизация и получение токена](#auth)
  * [Коды ошибок](#auth_error_codes)
  * [Авторизация](#auth_login)
  * [Обновление токена](#auth_refresh_token)
- [Доступ к данным всех организаций (DbInfoApi)](#----------------------------------dbinfoapi-)
  * [Коды ошибок](#------------1)
  * [Получение списка организаций](#----------------------------)
  * [Удаление всех организаций](#-------------------------)
- [Доступ к данным организации (OrganizationApi)](#-----------------------------organizationapi-)
  * [Коды ошибок](#------------2)
  * [Получение списка факультетов выбранной организации](#--------------------------------------------------)
  * [Удаление выбранной организаций](#------------------------------)
- [Доступ к данным факультетов (FacultyApi)](#-----------------------------facultyapi-)
  * [Коды ошибок](#------------3)
  * [Получение списка групп выбранного факультета](#--------------------------------------------)
  * [Удаление выбранного факультета](#------------------------------)
- [Доступ к данным групп (GroupApi)](#-----------------------groupapi-)
  * [Коды ошибок](#------------4)
  * [Получение тега выбранной группы](#-------------------------------)
  * [Добавление новой группы](#-----------------------)
  * [Изменение данных выбранной группы](#---------------------------------)
  * [Удаление выбранной группы](#-------------------------)
- [Доступ к данным расписания занятий выбранной группы (ScheduleApi)](#-----------------------------------------------------scheduleapi-)
  * [Коды ошибок](#------------5)
...
- [Доступ к данным расписания экзаменов выбранной группы (ExamsApi)](#-------------------------------------------------------examsapi-)
  * [Коды ошибок](#------------6)
