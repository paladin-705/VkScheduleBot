...
Тажке, если вы уже создали пользоватля для [VkScheduleBot Control Panel](https://github.com/paladin-705/VkScheduleBotDB_ControlPanel), то вы можете использовать его данные.
